...
public class ReservationController {
    ...
    @Operation(summary = "Créer une réservation", description = "Crée une réservation pour un livre indisponible. Le client n'envoie que livreId et adherentId.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Lister les réservations", description = "Liste les réservations, filtrable par statut et par adhérent.")
    @ApiResponses(value = {
